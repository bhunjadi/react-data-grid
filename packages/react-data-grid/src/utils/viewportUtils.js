...
export const getRowOverscanStartIdx = (scrollDirection, rowVisibleStartIdx, keepAllRowsInDOM) => {
  if (keepAllRowsInDOM) {
    return 0;
  }
...
export const getRowOverscanEndIdx = (scrollDirection, rowVisibleEndIdx, rowsCount, keepAllRowsInDOM) => {
  if (keepAllRowsInDOM) {
    return rowsCount;
  }
